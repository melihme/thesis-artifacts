#!/usr/bin/env python3
"""Validate the public Twitter split IDs used only by the domain-shift workflow."""
...
def main() -> None:
    root = ROOT_DIR / "datasets" / "domain_shift" / "twitter_ner" / "split_ids"
    seen: set[str] = set()
    for split, expected_count in EXPECTED.items():
        ...
        seen.update(values)
    print("Domain-shift Twitter split IDs are valid: train=1347, validation=292, test=286.")
